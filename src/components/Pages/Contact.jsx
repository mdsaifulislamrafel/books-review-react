    ...
    return (
        <section className="p-6 dark:text-gray-800">
            <form noValidate="" className="container w-full max-w-xl p-8 mx-auto space-y-6 rounded-md shadow bg-gray-200">
                ...
                <div>
                    <Link to="/" type="submit" className="w-full flex flex-col items-center justify-center  bg-green-500 text-white px-4 py-2 font-bold rounded shadow focus:outline-none focus:ring hover:ring focus:ring-opacity-50 dark:bg-violet-600 focus:dark:ring-violet-600 hover:dark:ring-violet-600 dark:text-gray-50">Send</Link>
                </div>
            </form>
        </section>
    );
